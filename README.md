...
<body>
    ...
    <section id="about">
        <div class="section-content">
            <h2>About Me</h2>
            <p>I'm nan mudhalvan student,it's very helpful for me,i'm dedicated to staying up to date with the latest trends and innovation in the nan mudhalvan classes....'</p>
        </div>
    </section>
